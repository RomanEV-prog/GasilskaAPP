...
| 12 | 🔴 | Prijava po ponovni namestitvi (mobilna, 1.0.18) | Googlov Auto Backup je ob ponovni namestitvi obnovil šifrirano shrambo brez ključa v Keystore → vsa branja so metala izjeme, seznam društev pa je javljal zavajajočo »omrežno« napako. Izklopljen backup (`allowBackup=false` + `data_extraction_rules`), branje shrambe ločeno od omrežnega klica s samodejnim čiščenjem pokvarjene. Dodano: gumb »Poskusi znova« pri seznamu društev, 👁 prikaz gesla ob vpisu, nova ikona aplikacije. Diagnoza v živo (tcpdump na strežniku + logcat; `pm clear` potrdil vzrok). | 3. 8. 2026 |

Točke 1–4 rešene v seji 22. 7. 2026; točke 5–7 v seji 24.–25. 7. 2026;
točke 8–10 v seji 29. 7. 2026; točka 11 v seji 3. 8. 2026 (izdaja 1.0.17, koda 18); točka 12 v isti seji (izdaja 1.0.18, koda 19).
